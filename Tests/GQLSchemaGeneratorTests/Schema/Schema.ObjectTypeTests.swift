//
//  __Schema.ObjectTypeTests.swift
//  Gryphin
//
...
class SchemaObjectTypeTests: XCTestCase {
    ...
    func testInitNonNullScalar() {
        ...
        let type   = __Schema.__ObjectType(json: json)
    ...
    static var allTests = [
        ("testInitNonNullScalar", testInitNonNullScalar),
        ("testInitNullableScalar", testInitNullableScalar),
        ("testInitNonNullObjectCollection", testInitNonNullObjectCollection),
    ]
}
